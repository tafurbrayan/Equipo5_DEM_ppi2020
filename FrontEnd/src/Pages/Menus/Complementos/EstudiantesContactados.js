...
import SiReal from "../../../Imagenes/img/Contacto.png";

export default function EstudiantesContactados() {
  return (
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-backspace-reverse-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
